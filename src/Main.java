...
public class Main {
    ...
    static JLabel text=new JLabel("Gebe eine Zahl zwische 0 und 100 ein");
    static JTextField textField=new JTextField();

    public static void main(String[] args){
        System.out.println("The mumber is:" +myNumber);
 openUI();
        //nextRound();
    }
    public static void openUI(){
        ...
        button.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) { try{String textFromTextfield=textField.getText();
